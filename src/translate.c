...
void translate_constant(is_constant *node)
{
	...
	switch (node->type)
	{
		...
		case t_constant_string:	
			OUT("\t_registers[%d] = (REGISTER)strdup(%s);\n",
				node->temp,
